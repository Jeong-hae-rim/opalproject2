...
<section class="banner" role="banner">
        <header id="header">
            <div class="header-content clearfix">
                <a class="logo" href="#"><img src="resources/images/Opal.png" width="100" alt=""></a>
    ...
    <div class="SicknessWrap">
                     <div class="sickness">
                        ...
                        <div id="check_item">
                          <label class="checkbox-label"><input type="checkbox"/><span class="checkbox-custom rectangular"></span></label>
                  ...
                  <div>
                  <h3 class="h3_sick">관심있는 질병의 버튼을 눌러주세요.</h3>
                  </div>
    </section>
