	...
	<br><br>
		<form>
			<fieldset>
				...
				<div class="form-group">
					<label for="productCd">상품 코드</label> 
					<input type="text" class="form-control" placeholder="상품 코드를 입력하세요."> 
				</div>
				<div class="form-group">
					<label for="farmCd">농부 코드</label> 
					<input type="text" class="form-control" placeholder="농부 코드를 입력하세요."> 
				</div>
				<div class="form-group">
					<label for="productName">상품 이름</label> 
					<input type="text" class="form-control" placeholder="상품 이름을 작성하세요."> 
				</div>
				<div class="form-group">
					<label for="productPrice">상품 가격</label> 
					<input type="number" class="form-control" placeholder="상품 가격을 입력해주세요.">
				</div>
				<div class="form-group">
					<label for="productSu">상품 수량</label> 
					  <input id="product" type="text" class="form-control" placeholder="상품 수량을 입력해주세요.">
				...
				<div class="form-group">
					...
					<textarea class="form-control" id="productContent" rows="20"></textarea>
				</div>
				<div class="form-group">
					<label for="exampleInputFile">File input</label> <input type="file"
						class="form-control-file" id="exampleInputFile"
						aria-describedby="fileHelp"> <small id="fileHelp"
						class="form-text text-muted">상품 이미지 넣는 거?</small>
				</div>
