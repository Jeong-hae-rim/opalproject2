            ...
            <tbody>
               <tr>
                  ...
                  <td class="td_text"><input
                     style="width: 200px; text-align: left;" type="text"></td>
               </tr>
               <tr>
                  <td class="td_name">아이디</td>
                  <td class="td_text"><input
                     style="width: 200px; text-align: left;" type="text">&nbsp;&nbsp;<input
               ...
               <tr>
                  ...
                  <td class="td_text"><input
                     style="width: 200px; text-align: left;" type="text"> <span>&nbsp;&nbsp;*비밀번호
                        확인을 위해서 한 번만 더 입력해주세요.</span></td>
               </tr>
               <tr>
                  <td class="td_name">별명</td>
                  <td class="td_text"><input
                     style="width: 200px; text-align: left;" type="text"></td>
               </tr>
               <tr>
                  ...
                  <td class="td_text"><input
                     style="width: 200px; text-align: left;" type="date"></td>
               </tr>
               <tr>
                  <td class="td_name">성별</td>
                  <td class="td_text"><label><input type="radio"
                        name="check" value="female" checked>여자</label> <label><input
                        type="radio" name="check" value="male">남자</label></td>
               </tr>
               <tr>
                  <td class="td_name">이메일</td>
                  <td class="td_text">
                    <input id="emailId" style="width: 200px; text-align: left;" type="text"> 
                    <span>@</span> <input id="textEmail" style="width: 200px; text-align: left;" placeholder="이메일을 선택하세요.">
                     <select id="select">
               ...
               <tr>
                  ...
                  <td class="td_text">
                     ...
                     <input type="text" id="sample6_address" placeholder="주소" style="width: 300px;"><br> 
                     <input type="text" id="sample6_detailAddress" placeholder="상세주소" style="width: 500px;">
