			...
			<div id="card_feagure" class="card border-success mb-3" style="max-width: 40rem;">
				...
				<div class="card-body">
					<form method='post' action="/opalproject/login">
						<div>
							<input class="input" type="text" name="username" value="admin" placeholder="아이디">
						</div>
						<div>
							<input class="input" type="password" name="password" value="admin" placeholder="비밀번호">
						</div>
						<div>
					...
					<div class="en">
					<a href="/opalproject/entrance">회원가입</a> 
					<span> | </span> 
