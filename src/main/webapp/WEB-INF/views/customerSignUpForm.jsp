			...
			<table>
				<tbody>
					<tr>
						...
						<td class="td_text"><label for="radio"><input
								id="radio" type="radio" name="member" value="<%=member%>"
								checked disabled>고객</label> <label for="radio"><input
								id="radio" type="radio" name="member" disabled>파트너</label></td>
					</tr>
					</tr>
					<tr>
						...
						<td class="td_text"><input
							...
							name="cust_name" autocomplete=”off” required></td>
					</tr>
					<tr>
						<td class="td_name">아이디</td>
						<td class="td_text"><input
							style="width: 200px; text-align: left;" type="text"
							name="cust_id" autocomplete=”off” required>&nbsp;&nbsp;<input
					...
					<tr>
						...
						<td class="td_text"><input
							...
							name="cust_pw" autocomplete=”off” min=6 max=11 required></td>
					</tr>
					<tr>
						<td class="td_name">비밀번호 확인</td>
						<td class="td_text"><input
							style="width: 200px; text-align: left;" type="password"
							autocomplete=”off” min=6 max=11 required> <span>&nbsp;&nbsp;*비밀번호
					...
					<tr>
						...
						<td class="td_text"><label for="radio"><input
								id="radio" type="radio" name="cust_gender" checked>여자</label> <label
							for="radio"><input id="radio" type="radio"
								name="cust_gender">남자</label></td>
					</tr>

					<tr>
						<td class="td_name">이메일</td>
						<td class="td_text"><input id="emailId"
							style="width: 200px; text-align: left;" type="text"
							name="cust_email1" autocomplete=”off” required> <span>@</span>
							<input id="textEmail" style="width: 200px; text-align: left;"
							placeholder="이메일을 선택하세요." name="cust_email2" autocomplete=”off”
					...
					<tr>
						...
						<td class="td_text"><input
							...
							name="cust_birthday_date" autocomplete=”off” required></td>
					</tr>
					...
					<tr>
						...
						<td class="td_text"><input type="number"
							style="width: 200px; text-align: left;" type="text"
							name="cust_pnum1" autocomplete=”off” required>- <input
							type="number" style="width: 200px; text-align: left;" type="text"
							name="cust_pnum2" autocomplete=”off” required>- <input
							type="number" style="width: 200px; text-align: left;" type="text"
							name="cust_pnum3" autocomplete=”off” required></td>
					</tr>

					<tr>
						<td class="td_name">주소</td>
						<td class="td_text"><input type="text" id="sample6_postcode"
							placeholder="우편번호" name="cust_address1" autocomplete=”off”
							disabled required> <input type="button"
							onclick="sample6_execDaumPostcode()" value="우편번호 찾기"
							autocomplete=”off”><br> <input type="text"
							id="sample6_address" placeholder="주소" style="width: 300px;"
							name="cust_address2" autocomplete=”off” disabled required><br>
							<input type="text" id="sample6_detailAddress" placeholder="상세주소"
							style="width: 500px;" name="cust_address3" autocomplete=”off”
							required> <input type="text" id="sample6_extraAddress"
							placeholder="참고항목" name="cust_address4" autocomplete=”off”
