...
<%String member = (String)request.getAttribute("member"); %>
   <section id="entrance">
      <h2>회원가입</h2>
      <form method="post" action="/opalproject/customerSignUpComplete" >
         <table>
            <tbody>
             	<tr>
		 	...
		 	<label for="radio"><input id= "radio" type="radio" name="member" disabled>파트너</label>
               ...
               <tr>
                  ...
                  <td class="td_text"><input
                     style="width: 200px; text-align: left;" type="password" name="cust_pw" autocomplete=”off” required></td>
               </tr>
               <tr>
                  <td class="td_name">비밀번호 확인</td>
                  <td class="td_text"><input
                     style="width: 200px; text-align: left;" type="password" autocomplete=”off” required> <span>&nbsp;&nbsp;*비밀번호
               ...
               <tr>
                  ...
                  <td class="td_text">
                  <input style="width: 200px; text-align: left;" type="text" name="cust_pnum1" autocomplete=”off” required>-
                  <input style="width: 200px; text-align: left;" type="text" name="cust_pnum2" autocomplete=”off” required>-
                  <input style="width: 200px; text-align: left;" type="text" name="cust_pnum3" autocomplete=”off” required></td>
               </tr>
